	...
	SecurityFilterChain securityFilterChain(
		...
		return http
				...
				.authorizeHttpRequests((requests) -> requests
						...
						.requestMatchers(HttpMethod.GET, "/api/v1/me/payable-attendances").hasRole("WORKER")
						.requestMatchers(HttpMethod.POST, "/api/v1/me/payout-requests/preview")
						.hasRole("WORKER")
						.requestMatchers(HttpMethod.POST, "/api/v1/me/payout-requests").hasRole("WORKER")
						.requestMatchers(HttpMethod.GET, "/api/v1/me/payout-requests").hasRole("WORKER")
						.requestMatchers(HttpMethod.GET, "/api/v1/me/managed-payout-requests")
						.hasRole("FOREMAN")
						...
						.hasAnyRole("FOREMAN", "ADMIN")
						.requestMatchers(HttpMethod.POST, "/api/v1/shifts").hasRole("FOREMAN")
						...
						.hasAnyRole("FOREMAN", "WORKER")
						.requestMatchers(HttpMethod.POST, "/api/v1/shifts/{shiftId}/pauses/all/start")
						.hasRole("FOREMAN")
						.requestMatchers(HttpMethod.POST, "/api/v1/shifts/{shiftId}/pauses/all/end")
						.hasRole("FOREMAN")
